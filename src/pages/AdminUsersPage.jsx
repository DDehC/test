...
export default function AdminUsersPage() {
  ...
  const [role, setRole] = useState("all");       // "all" | "staff" | "admin" | "student"
  const [status, setStatus] = useState("active"); // "all" | "active" | "inactive"
...
function UserModal({ title, initial, onClose, onSubmit }) {
  ...
  function submit(e){
    ...
    if (password.trim()) payload.password = password.trim(); // Only send password if provided
    onSubmit(payload);
  }
