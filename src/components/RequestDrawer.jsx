    ...
    <div className="rd-overlay" role="dialog" aria-modal="true">
      <aside className="rd-sheet">
        ...
        <section className="rd-body">
          <div className="rd-meta">
            <div>
              ...
              <span className="v">{organization || "—"}</span>
            </div>
            <div>
            ...
            <div>
              ...
              <span className="v">{on_campus ? "Campus" : location || "—"}</span>
            </div>
            <div>
              <span className="k">Status</span>
              <span className={`v pill status--${status}`}>{status}</span>
            </div>
          </div>
        ...
        <footer className="rd-actions">
          ...
          <button className="btn btn--lightdanger" onClick={confirmDelete}>
            Delete
          </button>
          <button className="btn" onClick={() => onApprove(id, feedback)}>
            Approve
          </button>
          <button className="btn btn--danger" onClick={() => onDeny(id, feedback)}>
            Deny
          </button>
