    ...
    <div className="rd-overlay" role="dialog" aria-modal="true">
      <aside className="rd-sheet">
        ...
        <footer className="rd-actions">
          ...
          <button className="btn btn--success" onClick={() => onApprove(formData.id, feedback)}>Approve</button>
      ...
      <style>{`
        ...
        .btn--success:focus-visible{outline:3px solid rgba(22,163,74,.35);outline-offset:2px}
        .spacer{flex:1}
